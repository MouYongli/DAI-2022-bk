...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="PyTorch FedProx")
    ...
    exp_dir = osp.join(here, "../../Experiments", f"d_{args.num_data_mnist}_{args.num_data_svhn}_{args.num_data_usps}_{args.num_data_synth}_{args.num_data_mnistm}", "fedprox", f"r_{args.num_rounds}_e_{args.num_epochs}")
    ...
    if args.log:
        ...
        logfile = open(os.path.join(log_path,'fedprox'), 'a')
