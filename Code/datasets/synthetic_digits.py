...
if __name__ == '__main__':
    ...
    synthetic_digits_trainset = SyntheticDigits(root='./SyntheticDigits', train=True, download=True, transform=transform)
    synthetic_digits_trainloader = torch.utils.data.DataLoader(synthetic_digits_trainset, batch_size=batch_size, shuffle=True)
    synthetic_digits_testset = SyntheticDigits(root='./SyntheticDigits', train=False, download=True, transform=transform)
    synthetic_digits_testloader = torch.utils.data.DataLoader(synthetic_digits_testset, batch_size=batch_size, shuffle=False)

    # get some random training images
    dataiter = iter(synthetic_digits_testloader)
